...
import 'package:todotask1/main.dart';
import 'package:todotask1/screen/singup.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF9B4F87), // สีแถบด้านบน
      ),
      body: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(0.0), // ขอบโค้ง
            boxShadow: [
              BoxShadow(
